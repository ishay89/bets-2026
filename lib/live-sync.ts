...
// latency penalty when no matches are active. Recently-finished matches stay
// eligible until they age out of the live window so an old 90-minute display
// snapshot can be reconciled to the provider's full match score.
